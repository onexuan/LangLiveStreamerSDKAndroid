...
/**
 * Created by com.snail on 16/5/16.
 */
public class CustomCaptureManager {
    ...
    public interface ScanCompleteListener{
        void onScanComplete(Intent intent);
    }

    private ScanCompleteListener mScanCompleteListener;

    public void setScanCompleteListener(ScanCompleteListener scanCompleteListener) {
        mScanCompleteListener = scanCompleteListener;
    }
    ...
    public CustomCaptureManager(Activity activity, CompoundBarcodeView barcodeView) {
    ...
    protected void returnResult(BarcodeResult rawResult) {
        ...
        if(mScanCompleteListener!=null)
            mScanCompleteListener.onScanComplete(intent);
    }
