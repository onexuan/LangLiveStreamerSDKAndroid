...
public class LangRecordHandler extends Handler {
    ...
    private WeakReference<SnailRecordListener> mWeakListener;

    public LangRecordHandler(SnailRecordListener listener) {
    ...
    public void handleMessage(Message msg) {
        SnailRecordListener listener = mWeakListener.get();
        if (listener == null) {
            return;
        }
    ...
    public interface SnailRecordListener {
