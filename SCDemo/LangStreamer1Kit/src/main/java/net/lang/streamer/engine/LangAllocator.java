...
public final class LangAllocator {
     ...
     */
    public LangAllocator(int individualAllocationSize) {
     ...
     */
    public LangAllocator(int individualAllocationSize, int initialAllocationCount) {
