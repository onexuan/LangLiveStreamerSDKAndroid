...
public class LangEncodeHandler extends Handler {
    ...
    private WeakReference<SnailEncodeListener> mWeakListener;

    public LangEncodeHandler(SnailEncodeListener listener) {
    ...
    public void handleMessage(Message msg) {
        SnailEncodeListener listener = mWeakListener.get();
        if (listener == null) {
            return;
        }
    ...
    public interface SnailEncodeListener {
