...
Java_net_lang_streamer_rtc_io_agora_ex_MediaPreProcessing_setCallback(JNIEnv *env, jobject obj,
                                                                jobject callback) {
    if (!rtcEngine) return;
...
JNIEXPORT void JNICALL
Java_net_lang_streamer_rtc_io_agora_ex_MediaPreProcessing_setVideoDecodeByteBuffer(JNIEnv *env,
                                                                             jobject type,
                                                                             jint uid,
                                                                             jobject byteBuffer) {
    if (byteBuffer == nullptr) {
...
JNIEXPORT void JNICALL
Java_net_lang_streamer_rtc_io_agora_ex_MediaPreProcessing_releasePoint(JNIEnv *env, jobject type) {
    agora::util::AutoPtr<agora::media::IMediaEngine> mediaEngine;
    mediaEngine.queryInterface(rtcEngine, agora::INTERFACE_ID_TYPE::AGORA_IID_MEDIA_ENGINE);
