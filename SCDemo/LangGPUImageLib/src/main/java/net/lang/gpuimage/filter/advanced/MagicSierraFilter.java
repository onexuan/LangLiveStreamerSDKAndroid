...
public class MagicSierraFilter extends GPUImageFilter{
	...
	public MagicSierraFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.sierra, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(context, "filter/sierravignette.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(context, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(context, "filter/sierramap.png");
		    }
	    });
	}
}