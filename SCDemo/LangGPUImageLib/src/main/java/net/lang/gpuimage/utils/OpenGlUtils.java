...
public class OpenGlUtils {
    ...
    public static int loadTexture(final Context context, final String name){
        ...
        if (textureHandle[0] != 0){
            ...
            if (bitmap == null) {
                bitmap = getImageFromAssetsFile(context, name);
            }

            //getImageFromAssetsFile(context,name);
    ...
    public static int loadTexture(final int width, final int height) {
        final int[] textureHandle = new int[1];
        GLES20.glGenTextures(1, textureHandle, 0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textureHandle[0]);
    ...
    public static int loadProgram(final String strVSource, final String strFSource) {
        ...
        checkGlError("glGetProgramiv iProgId=" + iProgId + " iVShader=" + iVShader + " iFShader=" + iFShader);
    ...
    private static int loadShader(final String strSource, final int iType) {
        ...
        checkGlError("glCreateShader type=" + iType + "source=" + strSource);
    ...
    public static String readShaderFromRawResource(final int resourceId, Context ctx){
        final InputStream inputStream = ctx.getResources().openRawResource(
                resourceId);
