...
public class MagiSkinWhitenFilter extends GPUImageFilter {
    ...
    public MagiSkinWhitenFilter(Context context) {
    	super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.skinwhiten, context));
    }
