...
public class MagicWaldenFilter extends GPUImageFilter{
	...
	public MagicWaldenFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.walden, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(context, "filter/walden_map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(context, "filter/vignette_map.png");
		    }
	    });
	}
}
