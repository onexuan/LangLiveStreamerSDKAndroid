...
public class MagicNashvilleFilter extends GPUImageFilter{
	...
	public MagicNashvilleFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.nashville, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(context, "filter/nashvillemap.png");
		    }
	    });
	}
}
