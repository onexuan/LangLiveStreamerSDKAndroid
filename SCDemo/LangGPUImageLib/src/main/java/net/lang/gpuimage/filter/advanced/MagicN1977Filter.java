...
public class MagicN1977Filter extends GPUImageFilter{
	...
	public MagicN1977Filter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.n1977, context));
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(context, "filter/n1977map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(context, "filter/n1977blowout.png");
		    }
	    });
	}
}
