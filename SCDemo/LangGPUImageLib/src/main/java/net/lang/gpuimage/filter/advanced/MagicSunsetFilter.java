...
public class MagicSunsetFilter extends GPUImageFilter{
	...
	public MagicSunsetFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.sunset, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(context, "filter/rise_mask1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(context, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
