...
package net.lang.gpuimage.filter.base.gpuimage;
...
import static net.lang.gpuimage.utils.TextureRotationUtil.CUBE;
import static net.lang.gpuimage.utils.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
     ...
     * (non-Javadoc)
     * @see
     * jp.co.cyberagent.android.gpuimage.filter.GPUImageFilter#onDisplaySizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see jp.co.cyberagent.android.gpuimage.filter.GPUImageFilter#onDrawFrame(int,
