...
public class MagicHealthyFilter extends GPUImageFilter{
	...
	public MagicHealthyFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.healthy, context));
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(context, "filter/healthy_mask_1.jpg");
		    }
	    });
	}
