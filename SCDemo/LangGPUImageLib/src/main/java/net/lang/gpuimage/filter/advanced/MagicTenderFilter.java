...
public class MagicTenderFilter extends GPUImageFilter{
	...
	public MagicTenderFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.tender, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(context, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
