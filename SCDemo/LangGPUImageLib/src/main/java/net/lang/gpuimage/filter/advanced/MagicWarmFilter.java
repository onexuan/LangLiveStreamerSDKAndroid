...
public class MagicWarmFilter extends GPUImageFilter{
	...
	public MagicWarmFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.warm, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(context, "filter/warm_layer1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(context, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
