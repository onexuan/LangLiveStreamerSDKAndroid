...
public class MagicSunriseFilter extends GPUImageFilter{
	...
	public MagicSunriseFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.sunrise, context));
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(context, "filter/amaro_mask1.jpg");
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(context, "filter/amaro_mask2.jpg");
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
		        mMaskGrey3TextureId = OpenGlUtils.loadTexture(context, "filter/toy_mask1.jpg");
		    }
	    });
	}
}
