...
public class MagicHudsonFilter extends GPUImageFilter{
	...
	public MagicHudsonFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.hudson, context));
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(context, "filter/hudsonbackground.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(context, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(context, "filter/hudsonmap.png");
		    }
	    });
	}
}
