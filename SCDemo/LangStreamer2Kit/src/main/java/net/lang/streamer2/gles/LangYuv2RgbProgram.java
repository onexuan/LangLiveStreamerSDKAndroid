...
public class LangYuv2RgbProgram {
    private static final String TAG = LangYuv2RgbProgram.class.getSimpleName();
     ...
     */
    public LangYuv2RgbProgram() {
        mProgramHandle = OpenGlUtils.loadProgram(VERTEX_SHADER, FRAGMENT_SHADER);
        if (mProgramHandle == 0) {
        ...
        LangYuv2RgbProgram.checkLocation(maPositionLoc, "aPosition");
        maTextureCoordLoc = GLES20.glGetAttribLocation(mProgramHandle, "aTextureCoord");
        LangYuv2RgbProgram.checkLocation(maTextureCoordLoc, "aTextureCoord");
        muYtexLoc = GLES20.glGetUniformLocation(mProgramHandle, "Ytex");
        LangYuv2RgbProgram.checkLocation(muYtexLoc, "Ytex");
        muUtexLoc = GLES20.glGetUniformLocation(mProgramHandle, "Utex");
        LangYuv2RgbProgram.checkLocation(muUtexLoc, "Utex");
        muVtexLoc = GLES20.glGetUniformLocation(mProgramHandle, "Vtex");
        LangYuv2RgbProgram.checkLocation(muVtexLoc, "Vtex");
        mucolorConversionMatrixLoc = GLES20.glGetUniformLocation(mProgramHandle, "colorConversionMatrix");
        LangYuv2RgbProgram.checkLocation(mucolorConversionMatrixLoc, "colorConversionMatrix");
    ...
    public void draw(FloatBuffer vertexBuffer,
        ...
        GLES20.glUniform1i(muYtexLoc, 0);
        OpenGlUtils.checkGlError("glUniform1i");

        GLES20.glUniform1i(muUtexLoc, 1);
        OpenGlUtils.checkGlError("glUniform1i");

        GLES20.glUniform1i(muVtexLoc, 2);
        OpenGlUtils.checkGlError("glUniform1i");
